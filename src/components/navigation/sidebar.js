...
function Sidebar() {
	...
	return (
		<nav className={`${expand ? `min-w-48 max-w-48 ${expandDuration}` : `min-w-[85px] max-w-[85px] ${expandDuration}`} border-r flex-col flex justify-between`}>
			...
			<div className='w-full items-center gap-5 p-5'>
				<div className='pb-5'>
					<Separator />
				</div>
